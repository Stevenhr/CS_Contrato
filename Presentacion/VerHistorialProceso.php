<html lang="es">
      ...
      <div class="container">          
          <div class="panel panel-default">
                <div class="panel-body">
                       ...
                       <form id="FR_BUSQUEDA_RADICADO" name="FR_BUSQUEDA_RADICADO" class="form-horizontal"  action="#" method="POST">
                           <input type="HIDDEN" name="HD_VALIDACION" value="busquedaNumeroRadicado">
                           <div class="form-group">
                              <label class="col-sm-2 control-label">Búsqueda por # radicado:</label>
                              <div class="col-sm-8">
                                  <input type="number" name="TX_RADICADO" class="form-control" id="TX_RADICADO"  required/>                                           
                              </div>
                              <div class="col-sm-2">
                       ...
                       <form id="FR_BUSQUEDA_ABOGADO" name="FR_BUSQUEDA_ABOGADO" class="form-horizontal"  action="#" method="POST">
                           <input type="HIDDEN" name="HD_VALIDACION" value="busquedaAbogado">
                           <div class="form-group">
                              <label class="col-sm-2 control-label">Búsqueda por abogado:</label>
                              <div class="col-sm-4">
                                  <select id="SL_ABOGADO" name="SL_ABOGADO" class="form-control" required>
                                        <option></option>
                                  </select>
                       ...
                       <form id="FR_BUSQUEDA_SUBDIRECCION" name="FR_BUSQUEDA_SUBDIRECCION" class="form-horizontal"  action="#" method="POST">
                           <input type="HIDDEN" name="HD_VALIDACION" value="busquedaSubdireccion">
                           <div class="form-group">
                              <label class="col-sm-2 control-label">Búsqueda por sub-dirección:</label>
                              <div class="col-sm-4">
                                  <select id="SL_SUBDIRECCION" name="SL_SUBDIRECCION" class="form-control" required>
                                        <option></option>                                        
                                  </select>
  ...
  <script src="Js/VerHistorialProceso.js"></script>  

  <script>Cargar_Funcionarios()</script>
  <script>Cargar_Subdireccion_Proceso()</script>
</html>
